...
export default async function AdminDashboardPage() {
  ...
  return (
    <section className="mb-10">
      <h3 className="text-[var(--color-carbon-black)] text-2xl font-bold mb-6">Resumen de la Plataforma</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow relative overflow-hidden">
          ...
          <p className="text-4xl font-bold text-[var(--color-carbon-black)]">--</p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow relative overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="p-2 bg-[var(--color-maya-blue)]/10 rounded-lg text-[var(--color-maya-blue)]">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow relative overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="p-2 bg-[var(--color-tropical-teal)]/10 rounded-lg text-[var(--color-tropical-teal)]">
